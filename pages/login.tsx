...
export default function Login() {
  return (
    ...
    >
      <article className="bg-gray-900 cursor-pointer hover:bg-gray-800 transition-colors max-w-lg flex rounded-lg p-4 border border-gray-600  w-full  flex-col">
        ...
        <div className="text-xs text-gray-300 mt-4 leading-relaxed">
          <span>
            ...
            დაამტკიცონ უდანაშაულობა სასამართლოს წინაშე. <span className=" cursor-pointer font-bold text-blue-500">გაიგე დეტალუტად</span>
          </span>
      ...
      <article className="bg-gray-900 cursor-pointer hover:bg-gray-800 transition-colors flex rounded-lg p-4 border border-gray-600  w-full  flex-col max-w-lg">
        <div className="flex gap-2">
          <MapPinCheckIcon />
